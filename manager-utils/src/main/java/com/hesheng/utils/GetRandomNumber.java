...
public class GetRandomNumber {
    ...
    public static final String LETTERCHAR = "abcdefghijkllmnopqrstuvwxyz";
    ...
    public static void main(String[] args) {
        System.out.println("返回一个定长的随机字符串(只包含大小写字母、数字8):" + generateString(8));
        System.out
                .println("LETTERCHARLETTERCHARLETTERCHARLETTERCHAR[" + generateMixString(4)+"]");
        System.out.println("返回一个定长的随机纯小写字母字符串(只包含大小写字母):"
                + generateLowerString(9));
        System.out.println("返回一个定长的随机纯大写字母字符串(只包含大小写字母):"
                + generateUpperString(8));
